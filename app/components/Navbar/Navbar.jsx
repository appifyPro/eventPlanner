          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden sm:flex sm:space-x-6">
              {navItems.map((item, index) => (
                <Link href="/" key={index}>
                  <h2 className={`text-lg transition duration-500 ease-in-out transform hover:text-blue-500 hover:scale-105`}>
  {item}
</h2>
            ...
            <div className="flex items-center">
              ...
              <div className="hidden sm:block">
                <button className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-md text-Accent rounded-lg group bg-gradient-to-br from-teal-300 to-lime-300 group-hover:from-teal-300 group-hover:to-lime-300 dark:text-white dark:hover:text-Accent focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-lime-800">
                  <span className="relative text-Accent2 px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-Accent rounded-md group-hover:bg-opacity-0">
                    Login
                  </span>
                </button>
              </div>
